...
def one_star(filename: str):
	...
	return sum(
		[get_num_characters_of_code(line) - get_num_characters_of_string(line) for line in lines]
	)
...
def two_star(filename: str):
	...
	return sum(
		[
			num_characters_of_code_after_encoding(line) - get_num_characters_of_code(line)
			for line in lines
		]
	)
