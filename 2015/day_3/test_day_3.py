...
from day_3 import map_instruction_to_direction, get_path, count_visits, split_instructions, two_star
...
@pytest.mark.parametrize("instruction, expected_houses_visited", [
    ('>', [(0, 0), (1, 0)]),
    ('', [(0, 0)]),
...
@pytest.mark.parametrize("instruction, expected_repeats", [
    ('>', 2),
    ('', 1),
    ('^>v<', 4),
    ('^v^v^', 2)
