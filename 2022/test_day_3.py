...
from day_3 import get_rucksacks, get_compartments, get_match, get_alphabetic_position, get_priority, group_into_three
...
@pytest.mark.parametrize("l,groups", [
    (["1", "2", "3", "4"], [["1", "2", "3"], ["4"]]),
...
def test_group_into_3_with_testfile(rucksacks):
    ...
    assert g[0] == ["vJrwpWtwJgWrhcsFMMfFFhFp",
                    "jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL",
                    "PmmdzqPrVvPwwTWBwg"]
    assert g[1] == ["wMqvLMZHhHMvwLHjbvcjnnSBnvTQFn",
                    "ttgJtRGJQctTZtZT",
                    "CrZsJsPPZsGzwwsLwLmpwMDw"]
