import pytest
from day_3 import extract_multiplication_instructions, read_conditional_instructions, MULTIPLICATION_PATTERN, CONDITIONAL_MULTIPLICATION_PATTERN
...
def test_find_mul_instructions(line, instructions):
    assert extract_multiplication_instructions(
        line, MULTIPLICATION_PATTERN) == instructions
