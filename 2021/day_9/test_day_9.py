...
from day_9 import get_array, is_point_min, get_adjacent_indeces, find_minima, find_size_of_basin_around_min_point
...
@pytest.mark.parametrize("r,c,expected_size", [
    (0, 1, 3),
    (2, 2, 14),
    (0, 9, 9),
    (4, 9, 9)
