...
from day_4 import load_data, convert_board_string_to_array, find_matching_index, create_new_board_status, is_board_winner
...
def new_board_status():
    return {'rows': {0: 0, 1: 0, 2: 0, 3: 0, 4: 0}, 'cols': {0: 0, 1: 0, 2: 0, 3: 0, 4: 0}}


@pytest.fixture
def board():
    return [[[22, 13, 17, 11, 0], [8, 2, 23, 4, 24], [21, 9, 14, 16, 7], [6, 10, 3, 18, 5], [1, 12, 20, 15, 19]],
...
@pytest.mark.parametrize("board,target,matching_index",
                         [
                             ([[1, 1], [1, 0]], 0, [(1, 1)]),
...
def test_new_board_status_2():
    assert create_new_board_status(
        2) == {"rows": {0: 0, 1: 0}, "cols": {0: 0, 1: 0}}


@pytest.mark.parametrize("expected,status",
                         [
                             (False, {'rows': {0: 1, 1: 1, 2: 2, 3: 1, 4: 0},
                              'cols': {0: 0, 1: 1, 2: 0, 3: 2, 4: 2}}),
                             (False, {'rows': {0: 0, 1: 2, 2: 1, 3: 2, 4: 0},
                                      'cols': {0: 1, 1: 1, 2: 1, 3: 0, 4: 2}}),
                             (True, {'rows': {0: 5, 1: 0, 2: 1, 3: 2, 4: 0},
                                     'cols': {0: 1, 1: 1, 2: 1, 3: 0, 4: 2}}),
                             (True, {'rows': {0: 5, 1: 0, 2: 1, 3: 2, 4: 0},
