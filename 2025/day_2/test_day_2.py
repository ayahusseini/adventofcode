...
from day_2 import (
	get_upper_half_pattern_bound,
	get_lower_half_pattern_bound,
	get_all_possible_invalid_ids,
	get_all_multiples,
)


@pytest.mark.parametrize('n, exp', [(2, [1, 2]), (3, [1, 3]), (5, [1, 5]), (10, [1, 2, 5, 10])])
...
@pytest.mark.parametrize(
	'maximum,nreps,exp',
	[(9999, 2, 99), (99, 2, 9), (100, 2, 9), (0, 1, 0), (0, 2, None)],
)
...
def test_large_range():
	...
	if ndigits[0] == ndigits[1]:
		...
		possible_reps = get_all_multiples(ndigits[0]) + get_all_multiples(ndigits[1])
